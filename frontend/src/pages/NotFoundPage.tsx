				...
				<CardFooter className="absolute bottom-0 z-10 flex items-center justify-center backdrop-blur-md ">
					<div className="flex flex-col">
						<p className="max-w-md font-serif text-sm italic text-center text-white ">
							&quot;From the dust to which our civilization first
							rose so too shall we return. As the light of our
							people fades to nothingness, we wonder if one will
							rise to rekindle our flame.&quot;
						</p>
					</div>
				</CardFooter>
			</Card>
